...
pub struct Tables<'tcx> {
    /// Resolve definitions for `<T>::X` associated projections.
    pub project_defs: NodeMap<Def>,
...
pub struct GlobalCtxt<'tcx> {
    ...
    pub provider: ty::demand::DepTrackingProvider<'tcx>,
    ...
    pub custom_coerce_unsized_kinds: RefCell<DepTrackingMap<maps::CustomCoerceUnsized<'tcx>>>,
...
impl<'a, 'gcx, 'tcx> TyCtxt<'a, 'gcx, 'tcx> {
    ...
    pub fn create_and_enter<F, R>(s: &'tcx Session,
                                  provider: Box<ty::demand::Provider<'tcx> + 'tcx>,
                                  arenas: &'tcx CtxtArenas<'tcx>,
                                  trait_map: TraitMap,
                                  ...
                                  where F: for<'b> FnOnce(TyCtxt<'b, 'tcx, 'tcx>) -> R
    {
        ...
        tls::enter_global(GlobalCtxt {
            sess: s,
            provider: ty::demand::DepTrackingProvider::new(provider),
            ...
            custom_coerce_unsized_kinds: RefCell::new(DepTrackingMap::new(dep_graph.clone())),
