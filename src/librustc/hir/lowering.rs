        ...
        P(hir::Pat {
            ...
            node: match p.node {
                ...
                PatKind::TupleStruct(ref path, ref pats, ddpos) => {
                    hir::PatKind::TupleStruct(self.lower_path(path, ParamMode::Optional),
                ...
                PatKind::Struct(ref pth, ref fields, etc) => {
                    let pth = self.lower_path(pth, ParamMode::Optional);
                    let fs = fields.iter()
                                   .map(|f| {
                                       Spanned {
                                           span: f.span,
        ...
        P(hir::Expr {
            ...
            node: match e.node {
                ...
                ExprKind::Struct(ref path, ref fields, ref maybe_expr) => {
                    hir::ExprStruct(self.lower_path(path, ParamMode::Optional),
